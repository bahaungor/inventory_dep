# Inventory App
An inventory management application that allows users to record and manage categories and items within those categories.
...
# Introduction
This inventory app is designed to help users manage and organize their inventory by recording categories and items within those categories. It provides a user-friendly interface for adding, editing, and deleting categories and items. This project demonstrates skills in application development, including user interface design and data management.
...
<a href="https://cloudinary.com/" target="_blank" rel="noreferrer"><img src="https://avatars.githubusercontent.com/u/45069436?s=200&v=4" alt="cloudinary" width="40" height="40"/></a>
